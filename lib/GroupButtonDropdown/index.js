...
})(['.ant-dropdown{left:0 !important;}.ant-dropdown-trigger{.ant-btn-primary{span{font-size:8px;margin-top:7px;display:inline-block;vertical-align:top;}}}.ant-dropdown-menu-light{border:1px solid rgba(205,210,217,0.5);border-radius:4px;background-color:white;box-shadow:0 4px 8px 0 rgba(0,0,0,0.08);}']);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_Icon2.default, { type: 'down_fillcaret' })
            )
          )
        )
      );
