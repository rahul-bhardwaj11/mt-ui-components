...
var MtModal = (0, _styledComponents2.default)(_modal2.default).withConfig({
  ...
  [
    '.ant-modal-content{box-shadow:0 4px 8px 0 rgba(0,0,0,0.25);}.ant-modal-body{padding:24px 32px;overflow:scroll;}.ant-modal-header{border-bottom:0px;padding:24px 32px;font-size:20px;.ant-modal-title{color:',
    ';font-size:20px;line-height:27px;}}.ant-modal-close{height:20px;width:20px;margin:24px 32px;}.ant-modal-close-x{font-size:20px;line-height:27px;height:20px;width:20px;}.ant-modal-footer{padding:21px 32px;background:',
    ';border-top:0px;.ant-btn{',
    ' ',
    ' color:',
    ';min-width:75px;&.ant-btn-primary{',
    ' ',
    ' color:#fff;&:hover{',
    ' color:#fff;}&:focus,&.active{',
