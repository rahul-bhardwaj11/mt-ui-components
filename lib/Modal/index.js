...
Modal.propTypes = {
  ...
  width: _propTypes2.default.oneOf([_propTypes2.default.number, _propTypes2.default.string])
};
Modal.defaultProps = {
  type: 'medium'
};
