...
var StyledModalWrapper = _styledComponents2.default.div.withConfig({
  ...
  ['.modalWrapper{z-index:', ';}.ant-modal-mask{z-index:', ';}'],
...
var MtModal = (0, _styledComponents2.default)(_modal2.default).withConfig({
  ...
  [
    '&.ant-modal{font-family:inherit;z-index:',
    ';.ant-modal-content{border-radius:8px;}.ant-modal-body{padding:0px 32px;overflow:auto;}.ant-modal-header{border-bottom:0px;padding:24px 32px;font-size:20px;border-radius:8px 8px 0 0;.ant-modal-title{',
    ';}}.ant-modal-close{height:20px;width:20px;margin:24px 32px;}.ant-modal-close-x{',
    ';line-height:27px;height:20px;width:20px;}.ant-modal-footer{padding:15px 32px 16px 32px;background:',
    ';border-top:1px solid ',
    ';;border-radius:0 0 8px 8px;margin-top:15px;.ant-btn{',
    ' color:',
    ';min-width:75px;&.ant-btn-primary{',
    ' color:',
    ';&:hover{',
    ' color:',
    ';}&:focus,&.active{',
    ...
    ';}}&:hover,&:focus{',
    ';color:',
    ';}}}@media (max-width:576px){margin:0px;top:0px;height:100vh;background:',
    ';.ant-modal-header{border-radius:0px;}.ant-modal-footer{position:fixed;bottom:0px;width:100%;border-radius:0px;}.ant-modal-content{border-radius:0px;box-shadow:0 0px 0px rgba(0,0,0,0.15);}}}.ant-confirm-body > .anticon{display:none;}'
  ],
...
var MtConfirmModal = _styledComponents2.default.div.withConfig({
  ...
  [
    '.ant-modal-wrap{z-index:',
    ';}.ant-modal-mask{z-index:',
    ';}.ant-modal{font-family:inherit;}.ant-confirm-body{.ant-confirm-content{margin-left:0px;}}.ant-modal-content{border-radius:8px;}.ant-confirm-btns{display:',
    ';}.ant-confirm-confirm .ant-confirm-body > .anticon{display:none;}.ant-confirm-body .ant-confirm-content{margin-left:0px;}.ant-confirm .ant-confirm-btns button + button{background:',
    ';border:1px solid ',
    ';}.ant-confirm-body .ant-confirm-title{',
    ';}.ant-confirm .ant-modal-close{display:block;}'
  ],
  _mixins2.default.zIndex.MODAL_WRAPPER,
  _mixins2.default.zIndex.MODAL_MASK,
  function(_ref) {
