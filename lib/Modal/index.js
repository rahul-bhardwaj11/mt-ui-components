...
})(['.ant-modal-wrap{z-index:', ';}.ant-modal-mask{z-index:', ';}.ant-modal{font-family:inherit;}.ant-confirm-body{.ant-confirm-content{margin-left:0px;}}.ant-modal-content{border-radius:8px;}.ant-confirm-btns{display:', ';}.ant-confirm-confirm .ant-confirm-body > .anticon{display:none;}.ant-confirm-body .ant-confirm-content{margin-left:0px;}.ant-confirm .ant-confirm-btns button + button{background:', ';border:1px solid ', ';}.ant-confirm-body .ant-confirm-title{', ';}'], _mixins2.default.zIndex.MODAL_WRAPPER, _mixins2.default.zIndex.MODAL_MASK, function (_ref) {
