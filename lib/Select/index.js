...
})(['display:inline-block;.ant-select,.ant-select-dropdown{font-family:inherit;}.ant-select-arrow{display:block;background:url(\'', '\') no-repeat 1px 4px;background-size:8px;width:9px;height:9px;&::before{content:\'\';}}'], _downFillcaret2.default);
