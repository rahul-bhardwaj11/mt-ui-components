...
var MtWrapper = _styledComponents2.default.div.withConfig({
  ...
  [
    "display:block;.selectDropdownStyle{z-index:999999;.ant-select-dropdown-menu-item{div{width:95%;text-overflow:ellipsis;overflow:hidden;white-space:nowrap;}}}.icon-tick{display:none;}.ant-select,.ant-select-dropdown{font-family:inherit;}.ant-select-arrow{display:block;background:url('",
    ...
    ';}}&:hover,&:focus,&:active,&:focus-within,&:visited{border-color:',
    ';box-shadow:none;}}.ant-select-open{.ant-select-selection{&.ant-select-selection--multiple{border:1px solid ',
    ';outline:none;&:hover,&:focus,&:active{border:1px solid ',
    ';border-color:',
    ';outline:none;box-shadow:none;}}}}.ant-select-dropdown-menu{background-color:',
    ';color:',
    ...
    ';color:',
    ";}.ant-select-dropdown-menu-item-selected{.icon-tick{content:'';font-size:7px;font-weight:bold;position:absolute;display:block;right:5px;top:13px;}&:hover{.icon-tick{display:block;}}}}.ant-select-selection-selected-value{font-weight:normal;div{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:100%;}}.ant-select-selection--multiple{padding:0;border:border-color:1px solid ",
    ';&:focus{border-color:1px solid ',
    ';box-shadow:none;}.ant-select-selection__rendered{& > ul{& > .ant-select-selection__choice{border-radius:14px;border:1px solid ',
    ...
    ';font-size:16px;}}}& > ul > li{margin-bottom:3px;}}}.ant-select-dropdown,.ant-select-dropdown--multiple{z-index:999999;}.mt-react-select__placeholder{color:',
    ';}'
  ],
