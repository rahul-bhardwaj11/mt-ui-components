...
})(['display:inline-block;margin:', ';border:none;background:transparent;border-radius:16px;.ant-tag{background:#fff;color:', ';font-size:12px;line-height:22px;border-radius:16px;height:24px;padding:0 15px;margin:0px;&:active{border:1px solid ', ';background-color:', ';color:', ';}}'], function (props) {
