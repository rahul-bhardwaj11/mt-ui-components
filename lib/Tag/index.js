...
var DefaultTag = _styledComponents2.default.div(_templateObject, _theme2.default.colors.OUTER_SPACE, function (_ref) {
  var _ref$margin = _ref.margin,
      margin = _ref$margin === undefined ? '0px 5px 12px 0px' : _ref$margin;
  return margin;
...
var Tag = function (_Component) {
  ...
  function Tag() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref2 = Tag.__proto__ || (0, _getPrototypeOf2.default)(Tag)).call.apply(_ref2, [this].concat(args))), _this), _this.getWrappedTag = function () {
