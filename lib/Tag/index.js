...
var ICON_TYPE = ((_ICON_TYPE = {}),
(0, _defineProperty3.default)(_ICON_TYPE, _style.TYPES.ADD, 'add'),
(0, _defineProperty3.default)(_ICON_TYPE, _style.TYPES.ADDED, 'cross'),
(0, _defineProperty3.default)(_ICON_TYPE, _style.TYPES.SELECTION, 'tick'),
_ICON_TYPE);
  ...
  (0, _createClass3.default)(Tag, [
    {
      ...
      value: function render() {
        ...
        var Tag = checkable ? _style.MtCheckableTag : _style2.default;

        var checkableTagProps = {
          checked: checked,
          onChange: onChange
        };
        var TagProps = (0, _extends3.default)(
          {
            type: type,
        ...
        return _react2.default.createElement(
          Tag,
          (0, _extends3.default)({}, TagProps, checkableTagProps),
          children,
          ICON_TYPE[type] &&
