...
var DefaultTag = _styledComponents2.default.button(_templateObject, function (props) {
...
var ActionTag = _styledComponents2.default.div(_templateObject2, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, function (props) {
  return getMargin(props);
});
var AppliedTag = _styledComponents2.default.div(_templateObject3, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.TROPICAL_BLUE, function (props) {
  return getMargin(props);
});

var DisabledTag = _styledComponents2.default.div(_templateObject2, _theme2.default.colors.SILVER, _theme2.default.colors.PEARL, function (props) {
  return getMargin(props);
});
...
var Tag = function (_Component) {
  ...
  function Tag() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Tag.__proto__ || (0, _getPrototypeOf2.default)(Tag)).call.apply(_ref, [this].concat(args))), _this), _this.styleProps = {
      ...
      switch (type) {
        case TYPES.DEFAULT:
          TagComponent = _react2.default.createElement(
            WrappedTag,
            (0, _extends3.default)({}, this.props, this.styleProps),
