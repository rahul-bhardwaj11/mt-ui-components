...
var AppliedStyle = (0, _styledComponents.css)(_templateObject, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.TROPICAL_BLUE);

var DisabledStyle = (0, _styledComponents.css)(_templateObject2, _theme2.default.colors.PEARL, _theme2.default.colors.SILVER, _theme2.default.colors.WHITE, _theme2.default.colors.PEARL, _theme2.default.colors.SILVER);

var DefaultTag = (0, _styledComponents.css)(_templateObject3, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.TROPICAL_BLUE, _theme2.default.colors.SILVER, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO);

var ActionTag = (0, _styledComponents.css)(_templateObject4, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.TROPICAL_BLUE, _theme2.default.colors.JODHPUR, _theme2.default.colors.JODHPUR, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.NEPTUNE, _theme2.default.colors.NEPTUNE);

var AddTag = (0, _styledComponents.css)(_templateObject5, _theme2.default.colors.SILVER, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.SILVER, _theme2.default.colors.DARK_OUTER_SPACE);

var AddedTag = (0, _styledComponents.css)(_templateObject6, _theme2.default.colors.PORCELAIN, _theme2.default.colors.SILVER, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.PORCELAIN, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.SILVER, _theme2.default.colors.DARK_OUTER_SPACE, _theme2.default.colors.PORCELAIN);

var SelectionTag = (0, _styledComponents.css)(_templateObject6, _theme2.default.colors.PORCELAIN, _theme2.default.colors.SILVER, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.PORCELAIN, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.SILVER, _theme2.default.colors.DARK_OUTER_SPACE, _theme2.default.colors.PORCELAIN);

var CheckableWrappedTag = (0, _styledComponents.css)(_templateObject7, _theme2.default.colors.ALTO, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.WHITE, _theme2.default.colors.ALTO, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.TAG_HOVER_TEXT_COLOR, _theme2.default.colors.TROPICAL_BLUE, _theme2.default.colors.TAG_HOVER_TEXT_COLOR, _theme2.default.colors.TAG_HOVER_TEXT_COLOR, _theme2.default.colors.TROPICAL_BLUE, _theme2.default.colors.TAG_HOVER_TEXT_COLOR, function (props) {
  return props.disabled ? DisabledStyle : '';
});

var ButtonWrapper = _styledComponents2.default.button(_templateObject8, function (props) {
  return getMargin(props);
}, _theme2.default.colors.WHITE, _theme2.default.colors.ALTO, _mixins2.default.smallGreyLink());

var WrappedTag = (0, _styledComponents2.default)(ButtonWrapper)(_templateObject9, function (props) {
  switch (props.type) {
    case TYPES.NORMAL:
      return DefaultTag;
    case TYPES.ADD:
