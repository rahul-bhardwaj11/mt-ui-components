...
})(['font-family:inherit;.ant-popover{z-index:', ';}.ant-popover-message-title{', ';padding-left:0px;}.ant-popover-inner-content{padding:24px;}.ant-popover-message > .anticon{display:none;}.ant-popover-buttons{margin-bottom:0px;.ant-btn{', ';', ';color:', ';min-width:75px;&.ant-btn-primary{', ';', ';color:#fff;&:hover{', ';color:#fff;}&:focus,&.active{', ';color:#fff;}}&:hover,&:focus{', ';color:', ';}}}'], _mixins2.default.zIndex.CONFIRM_BOX, _mixins2.default.blackLink(), _mixins2.default.textBtn(), _mixins2.default.button(), _theme2.default.colors.OUTER_SPACE, _mixins2.default.primaryBtn(), _mixins2.default.button(), _mixins2.default.primaryBtnHover(), _mixins2.default.primaryBtnHover(), _mixins2.default.textBtn(), _theme2.default.colors.ICON);
...
var ConfirmBox = function (_Component) {
  ...
  function ConfirmBox(p) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (ConfirmBox.__proto__ || (0, _getPrototypeOf2.default)(ConfirmBox)).call(this, p));
  ...
  (0, _createClass3.default)(ConfirmBox, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        null,
        _reactDom2.default.createPortal(_react2.default.createElement(StyledPopconfirm, { innerRef: function innerRef(e) {
