  ...
  (0, _createClass3.default)(Icon, [
    {
      ...
      value: function render() {
        ...
        var svgIcon = _svgIcons2.default[type];
        if (typeof _svgIcons2.default[type] == 'function') {
          svgIcon = _svgIcons2.default[type](styleProps);
        }
        style = gradient ? (0, _extends3.default)({}, style, svgIcon) : style;
        className = gradient
          ? className
