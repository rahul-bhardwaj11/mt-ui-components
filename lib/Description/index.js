...
var Description = function (_Component) {
  ...
  function Description() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Description.__proto__ || (0, _getPrototypeOf2.default)(Description)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      content: _this.props.content,
      availableLength: _this.props.maxLength,
      mode: _this.props.preview ? _constants.MODES.PREVIEW : _constants.MODES.EDIT
      ...
      !contentLength && trigger && required && (0, _Toast.errorToast)({ message: 'Description can not be empty' });
    }, _this.editorHelpers = {
      onOk: function onOk() {
      ...
      return mode == _constants.MODES.EDIT ? _react2.default.createElement(
        'div',
