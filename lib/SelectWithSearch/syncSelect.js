  ...
  function SyncSelect() {
    ...
    return (
      (_ret = ((_temp = ((_this = (0, _possibleConstructorReturn3.default)(
        this,
        (_ref = SyncSelect.__proto__ || (0, _getPrototypeOf2.default)(SyncSelect)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      ...
      (_this.toggleButton = function() {
        _this.setState(function(prevState) {
          ...
          updatedState = !_this.props.isButton ? { showInput: !prevState.showInput } : updatedState;
          return updatedState;
        });
        setTimeout(function() {
      ...
      (_this.optionWithCheckBox = function(_ref3) {
        ...
        return !isDisabled
          ? _react2.default.createElement(
              ...
              _react2.default.createElement('span', { className: 'dataLabel' }, data.label)
            )
          : null;
      }),
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement('span', { className: 'marginR5' }, ' Done'),
      ...
      (_this.handleControl = function(arg) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            {
              className: _this.state.showInput ? 'activeSearch' : '',
              onClick: function onClick() {
                _this.setState({
                  menuIsOpen: true,
                  showInput: true,
      ...
      (_this.handleInput = function(props) {
        if (props.isHidden) {
