  ...
  function SyncSelect() {
    ...
    return (
      ...
      (_this.handleClickOutside = function(event) {
        ...
        if (_this.selectRef && _this.selectRef.contains(event.target)) {
          _this.isBlurActive = false;
        }

        if (!_this.selectRef.contains(event.target)) {
          if (
            (_this.buttonRef && !_this.buttonRef.contains(event.target)) ||
            !_this.props.isButton
          )
            _this.props.isMulti
              ? _this.handleMultiOnSelect()
              : _this.handleSingleOnBlur();
        }
      }),
      ...
      (_this.getStyle = function() {
        var _this$props5 = _this.props,
          isButton = _this$props5.isButton,
          _this$props5$style = _this$props5.style,
          target = _this$props5$style === undefined ? {} : _this$props5$style;
        ...
        (0, _keys2.default)(target).forEach(function(key) {
          if (DEFAULT_SELECT_STYLE[key]) {
            styles[key] = function(rsCss, props) {
              return target[key](
                DEFAULT_SELECT_STYLE[key](rsCss, props),
                props
              );
            };
          } else {
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _state = this.state,
          ...
          prevSelectedItems = _state.prevSelectedItems,
