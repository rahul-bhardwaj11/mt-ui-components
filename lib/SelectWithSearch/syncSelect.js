...
var SyncSelect = function (_Component) {
  ...
  function SyncSelect() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = SyncSelect.__proto__ || (0, _getPrototypeOf2.default)(SyncSelect)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return sortedOptions;
    }, _this.onCheckboxClick = function (data, event) {
      if (event) {
        return;
      }
      ...
      var _this$state = _this.state,
          ...
          prevSelectedItems = _this$state.prevSelectedItems,
      ...
      if (isSelectedItemsChange) {
        ...
        _this.setState({ prevSelectedItems: selectedItems });
      }
      ...
      if (!_this.props.isMulti) return optionRenderer ? _react2.default.createElement(
        'div',
        {
          title: data.label,
          onClick: function onClick() {
            _this.handleSingleOnSelect(data);
          }
        },
        optionRenderer(data)
      ) : _react2.default.createElement(
      ...
      return !isDisabled ? _react2.default.createElement(
        ...
        {
          onClick: function onClick() {
            !data.disabled && _this.onCheckboxClick(data);
          },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              {
                type: 'text',
                onClick: _this.handleMultiOnSelect,
      ...
      var _this$props4 = _this.props,
          ...
          target = _this$props4$style === undefined ? {} : _this$props4$style;
  ...
  (0, _createClass3.default)(SyncSelect, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        showSelect && _react2.default.createElement(_reactSelect2.default, (0, _extends3.default)({
