...
var SyncSelect = function (_Component) {
  ...
  function SyncSelect(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (SyncSelect.__proto__ || (0, _getPrototypeOf2.default)(SyncSelect)).call(this, props));
  ...
  (0, _createClass3.default)(SyncSelect, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (value != nextProps.value || !this.isOptionsEqual(options, nextProps.options)) {
        var selectedItems = [];
        if (value) {
          selectedItems = this.getSelectedItemsFromValue(nextProps.value);
        }
        var sortedOptions = this.__sortOptions(nextProps.options, selectedItems);
        sortedOptions = this.normalizeOption(sortedOptions);
        this.setState({ options: sortedOptions, selectedItems: selectedItems });
      }
    }
  }, {
    key: 'render',
...
var _initialiseProps = function _initialiseProps() {
    ...
    if (value) {
      if (Array.isArray(value)) {
        value.forEach(function (item) {
          ...
          selectedItems.push.apply(selectedItems, (0, _toConsumableArray3.default)(option));
        });
      } else {
        var option = options.filter(function (option) {
  ...
  this.handleClickOutside = function (event) {
    ...
    if (!_this3.selectRef.contains(event.target)) {
      if (_this3.buttonRef && !_this3.buttonRef.contains(event.target) || !_this3.props.isButton) _this3.props.isMulti ? _this3.handleMultiOnSelect() : _this3.handleSingleOnBlur();
    }
  };
  ...
  this.optionWithCheckBox = function (params) {
    ...
    if (!_this3.props.isMulti) return optionRenderer ? _react2.default.createElement(
      'div',
      {
        title: data.label,
    ...
    return !isDisabled ? _react2.default.createElement(
      ...
      optionRenderer ? _react2.default.createElement(
        ...
        optionRenderer((0, _extends3.default)({}, data, { checked: checked }))
      ) : _react2.default.createElement(
        _CheckBox2.default,
        {
