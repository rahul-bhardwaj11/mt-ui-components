...
var _initialiseProps = function _initialiseProps() {
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _state3 = _this4.state, search = _state3.search, optionsCache = _state3.optionsCache;
  ...
  this.componentDidMount = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
    var _props3, defaultValue, isButton, value, _state4, optionsCache, search, currentOptions, newValue, selectedItems, arrangedOptions;

    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _props3 = _this4.props, defaultValue = _props3.defaultValue, isButton = _props3.isButton, value = _props3.value;
            _state4 = _this4.state, optionsCache = _state4.optionsCache, search = _state4.search;
            currentOptions = optionsCache[search] || initialCache;
  ...
  this.optionWithCheckBox = function (params) {
    ...
    return !isDisabled ? _react2.default.createElement(
      ...
      optionRenderer ? optionRenderer(data) : _react2.default.createElement(
        _CheckBox2.default,
        {
          disabled: data.disabled,
          checked: selectedItems.map(function (i) {
            return i.value;
          }).includes(data.value)
        },
        data.label
  ...
  this.handleControl = function (arg) {
    ...
    var isDisabled = _this4.props.isDisabled;
  ...
  this.getStyle = function () {
    var _props8 = _this4.props,
        isButton = _props8.isButton,
        _props8$style = _props8.style,
        target = _props8$style === undefined ? {} : _props8$style;
