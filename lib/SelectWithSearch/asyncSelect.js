...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getSelectedItemsFromValue = function (value) {
    ...
    var currentOptions = optionsCache[search] || initialCache;
    var options = _this3.normalizeOption([].concat((0, _toConsumableArray3.default)(currentOptions.options)));
    var selectedItems = [];
    if (value) {
    ...
    return _react2.default.createElement(
      ...
      isMulti && _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Button2.default,
            { type: 'text', id: 'asyncSelectClearBtn', onClick: _this3.onClearAll },
            'Clear All'
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Button2.default,
            { type: 'text', id: 'asyncSelectDoneBtn', onClick: _this3.handleMultiOnSelect },
            'Done',
            _react2.default.createElement(
              'span',
