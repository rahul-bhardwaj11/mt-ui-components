            ...
            switch (_context.prev = _context.next) {
              ...
              case 10:
                ...
                options.length && options.forEach(function (option) {
                  if (!currentOptions.options.filter(function (currOption) {
    ...
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _props3 = _this3.props, defaultValue = _props3.defaultValue, isButton = _props3.isButton, value = _props3.value;
