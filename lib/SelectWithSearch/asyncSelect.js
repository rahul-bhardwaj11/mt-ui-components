...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleClickOutside = function(event) {
    ...
    if (!_this4.selectRef.contains(event.target)) {
      if (
        (_this4.buttonRef && !_this4.buttonRef.contains(event.target)) ||
        !_this4.props.isButton
      )
      ...
      ? _react2.default.createElement(
          ...
          optionRenderer
            ? _react2.default.createElement(
                ...
                optionRenderer(
                  (0, _extends7.default)({}, data, { checked: checked })
                )
              )
            : _react2.default.createElement(
                _CheckBox2.default,
  ...
  this.normalizeOption = function(options) {
    if (
      !_this4.props.isMulti &&
      !_this4.state.search.length &&
      _this4.props.hasNone
    ) {
  ...
  this.getButtonText = function() {
    var _props9 = _this4.props,
      buttonLabel = _props9.buttonLabel,
      value = _props9.value;
  ...
  this.getStyle = function() {
    var _props10 = _this4.props,
      isButton = _props10.isButton,
      _props10$style = _props10.style,
      target = _props10$style === undefined ? {} : _props10$style;
  ...
  this.isValidNewOption = function(inputValue, selectValue, selectOptions) {
    ...
    var _props11 = _this4.props,
      isValidNewOption = _props11.isValidNewOption,
      isCreatable = _props11.isCreatable;
