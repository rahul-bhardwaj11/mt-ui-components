...
var SelectBox = _styledComponents2.default.div(
  ...
  function(_ref) {
    ...
    return !showSearch && isButton ? 'visibility: hidden; height:0px;' : null;
  },
  ...
  function(_ref2) {
    var showSearch = _ref2.showSearch,
      isButton = _ref2.isButton;
    return !showSearch && isButton ? 'visibility: hidden; ' : null;
  },
  function(props) {
  ...
  _theme2.default.colors.INDIGO,
  _mixins2.default.clearfix(),
  _mixins2.default.truncate('auto'),
