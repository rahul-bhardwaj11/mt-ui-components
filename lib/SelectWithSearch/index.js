...
var SelectBox = _styledComponents2.default.div.withConfig({
  ...
  [
    ...
    ";}.selectBoxWrapper{height:32px;.activeSearch{.mt-react-select__value-container{&:before{display:block;background:url('",
    "') no-repeat 10px 5px;}}.mt-react-select__single-value{padding-left:20px;}.mt-react-select__dropdown-indicator{display:none;}.mt-react-select__placeholder{padding-left:20px;}}}.mt-react-select__clear-indicator{display:none;}.mt-react-select__control{border:1px solid ",
    ';width:',
    ';}.mt-react-select__control--is-focused{box-shadow:none;border:1px solid ',
    ...
    ';height:32px;}.mt-react-select__option--is-selected{background-color:#ffffff;color:',
    ';}.mt-react-select__option--is-focused{background-color:',
    ';color:#ffffff;cursor:pointer;}.mt-react-select__indicator-separator{display:none;}.mt-react-select__input{padding-left:20px;}.mt-react-select__placeholder{}.ant-checkbox-wrapper .ant-checkbox{vertical-align:middle;margin-right:8px;}.mt-react-select__menu-list--is-multi{padding:19px 24px;}.ant-btn-text{padding:0px 24px;}.selectedItem{margin-left:2px;margin-right:2px;position:absolute;top:50%;-webkit-transform:translateY(-50%);-ms-transform:translateY(-50%);transform:translateY(-50%);}.componentWrapper{',
    ';width:100%;}.buttonWrapperL{float:left;width:50%;padding-bottom:10px;}.buttonWrapperR{float:right;padding-bottom:10px;}.dataLabel{',
    ';}.icon-Cancel{display:none;}.activeInput{.icon-Cancel{display:inline-block;position:absolute;right:10px;bottom:10px;cursor:pointer;}}.mt-react-select__value-container:before{height:22px;width:26px;}.checkboxWrapper{margin-bottom:5px;}.doneMarginR{margin-left:5px;}'
  ],
