...
var SelectBox = _styledComponents2.default.div.withConfig({
  ...
  [
    ...
    ';position:relative;}.mt-react-select__control--is-focused{box-shadow:none;border:1px solid ',
    ';}.mt-react-select__control--is-focused:hover{border:1px solid ',
    ...
    ';color:',
    ';cursor:pointer;}.mt-react-select__indicator-separator{display:none;}.ant-checkbox-wrapper .ant-checkbox{vertical-align:middle;margin-right:8px;}.mt-react-select__menu-list--is-multi{padding:19px 24px;}.selectedItem{margin-left:2px;margin-right:2px;font-size:14px;color:',
    ...
    ';width:100%;}.buttonWrapperL{float:left;width:50%;padding-bottom:10px;}.buttonWrapperR{width:50%;text-align:right;float:right;padding-bottom:10px;.activeBtnState{color:',
    ';}}.icon-cross{display:none;}.mt-react-select__value-container:before{height:22px;width:26px;}.checkboxWrapper{margin-bottom:5px;',
    ';}.doneMarginR{margin-left:5px;}'
  ],
