...
var MtCollapse = (0, _styledComponents2.default)('div').withConfig({
  displayName: 'Collapse__MtCollapse',
  componentId: 'sc-10ohtjv-0'
})(['.ant-collapse{border:0px;border-radius:0px;}.ant-collapse{& > .ant-collapse-item{&:last-child{border-radius:0px;}}& > .ant-collapse-item{&:last-child{& > .ant-collapse-header{border-radius:0px;}}}}.ant-collapse-header{font-weight:bold;background:#fff;}.ant-collapse{& > .ant-collapse-item{& > .ant-collapse-header{padding:12px 12px 12px 15px;}}}.ant-collapse{& > .ant-collapse-item{& > .ant-collapse-header{.arrow{font-size:0px;width:0;height:0;border-left:6px solid transparent;border-right:6px solid transparent;border-top:7px solid #6f7583;border-radius:2px;position:absolute;left:91%;}}}}.ant-collapse{& > .ant-collapse-item{& > .ant-collapse-header[aria-expanded=\'true\']{.arrow{transform:rotate(-90deg);position:absolute;left:91%;top:43%;}}}}']);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _collapse2.default,
          (0, _extends3.default)({}, this.props, { defaultActiveKey: ['0'] }),
