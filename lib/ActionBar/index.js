...
})(['position:fixed;max-width:100vw;bottom:0;width:', ';z-index:', ';left:0;right:0;margin:auto;background-color:white;padding:16px 32px;box-shadow:0 -1px 0 0 #e7e8ec,0 -2px 4px 0 rgba(0,0,0,0.08);.countText{', ';margin-right:29px;}'], function (_ref) {
...
var ActionBar = function ActionBar(_ref3) {
  ...
  return _react2.default.createElement(
    MtActionBar,
    style,
    countText && _react2.default.createElement(
      'span',
      { className: 'countText' },
      countText
    ),
