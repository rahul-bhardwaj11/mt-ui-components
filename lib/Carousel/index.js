...
var MtCarousel = (0, _styledComponents2.default)(_carousel2.default)(_templateObject, _leftCaret2.default, _leftCaret2.default, _rightCaret2.default, _rightCaret2.default, function (props) {
      ...
      if (fetchData) {
        ...
        if (hasMore) {
          ...
          fetchData({ offset: offset, pageSize: pageSize }).then(function (data) {
            ...
            data && data.length && _this.setState({
              children: newData,
