...
var MtCarousel = (0, _styledComponents2.default)(_carousel2.default).withConfig(
  ...
  [
    "padding:0 2em;font-family:inherit;.slick-disabled{visibility:hidden;}.slick-initialized .slick-slide{margin-right:20px;}.slick-next:before,.slick-prev:before{color:#000;}h3{background:#5f9ea0;color:#fff;font-size:36px;line-height:100px;margin:10px;padding:2%;position:relative;text-align:center;}.slick-next:before,.slick-prev:before{font-family:slick;font-size:20px;line-height:1;opacity:.75;color:black;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;}.slick-arrow.slick-prev{left:0px;font-size:20px;background-image:url('",
    "');background-repeat:no-repeat;background-size:38%;background-color:#989CA6;border-radius:22px;background-position:5px 4px;width:20px;height:20px;z-index:2;&:hover,&:focus{background:url('",
    "');background-repeat:no-repeat;background-size:38%;background-color:#989CA6;border-radius:22px;background-position:5px 4px;width:20px;height:20px;}&:before{display:none;}}.slick-arrow.slick-next{right:0px;font-size:20px;background:url('",
    "');background-repeat:no-repeat;background-size:38%;background-color:#989CA6;border-radius:22px;background-position:7px 4px;width:20px;height:20px;z-index:2;&:hover,&:focus{background:url('",
    "');background-repeat:no-repeat;background-size:38%;background-color:#989CA6;border-radius:22px;background-position:7px 4px;width:20px;height:20px;display:inline-block;}&:before{display:none;}}.slick-slide{",
    ';}&.slick-slider:before{content:"";position:absolute;z-index:1;left:0;top:0;width:120px;height:100%;background:linear-gradient( to right,rgba(255,255,255,1),rgba(255,255,255,0.6),rgba(255,255,255,0) );}&.slick-slider:after{content:"";position:absolute;z-index:1;top:0;right:0;width:120px;height:100%;background:linear-gradient( to left,rgba(255,255,255,1),rgba(255,255,255,0.6),rgba(255,255,255,0) );}&.left_arrow--disabled{&.slick-slider:before{visibility:hidden;}}&.right_arrow--disabled{&.slick-slider::after{visibility:hidden;}}'
  ],
  _leftCaret2.default,
  _leftCaret2.default,
...
var Carousel = (function(_Component) {
  ...
  function Carousel() {
    ...
    return (
      ...
      (_this.afterChange = function(current, next) {
        _this.fetch();
        _this.setState({
          current: current,
          next: next
  ...
  (0, _createClass3.default)(Carousel, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _getClassName = this.getClassName(),
