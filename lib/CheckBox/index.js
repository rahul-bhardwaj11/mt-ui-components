...
var MtCheckbox = _styledComponents2.default.div(_templateObject, _theme2.default.colors.LIGHT_BLUE, _theme2.default.colors.LIGHT_BLUE, _theme2.default.colors.DARK, _theme2.default.colors.OUTER_SPACE);
...
var CheckBox = function (_Component) {
  ...
  function CheckBox() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = CheckBox.__proto__ || (0, _getPrototypeOf2.default)(CheckBox)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (_this.props.onChange) _this.props.onChange(isChecked);
