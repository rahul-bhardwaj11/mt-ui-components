...
var MtCheckbox = _styledComponents2.default.div.withConfig({
  displayName: 'CheckBox__MtCheckbox',
  componentId: 'sc-1466g8a-0'
})(['display:inline-block;vertical-align:middle;.ant-checkbox-wrapper{.ant-checkbox:hover .ant-checkbox-inner,.ant-checkbox-input:focus + .ant-checkbox-inner{border-color:', ';}.ant-checkbox-indeterminate .ant-checkbox-inner:after{content:\' \';position:absolute;left:50%;top:50%;width:9.14285714px;height:2px;transform:translate(-50%,-50%) scale(1);background-color:#ffffff;}.ant-checkbox-indeterminate.ant-checkbox-disabled .ant-checkbox-inner:after{border-color:rgba(0,0,0,0.25);}.ant-checkbox-indeterminate .ant-checkbox-inner{background-color:', ';border-color:', ';}}.ant-checkbox-wrapper{font-weight:normal;display:inherit;.ant-checkbox{display:inline-block;vertical-align:middle;}.ant-checkbox + span{display:inline-block;vertical-align:top;min-width:125px;font-size:14px;}.ant-checkbox-inner{width:14px;height:14px;border-radius:3px;border:1px solid ', ';&:after{left:3.5px;top:1.2px;}}.ant-checkbox-checked{& > .ant-checkbox-inner{background-color:', ';border-color:', ';}}.ant-checkbox-checked + span{color:', ';}span{color:', ';}}'], _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.DARK, _theme2.default.colors.OUTER_SPACE);
