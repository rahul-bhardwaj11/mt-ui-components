...
})(['&.ant-checkbox-wrapper{font-family:inherit;.ant-checkbox:hover .ant-checkbox-inner,.ant-checkbox-input:focus + .ant-checkbox-inner{border-color:', ';}.ant-checkbox-indeterminate .ant-checkbox-inner:after{content:\' \';position:absolute;left:50%;top:50%;width:9.14285714px;height:2px;transform:translate(-50%,-50%) scale(1);background-color:#ffffff;}.ant-checkbox-indeterminate.ant-checkbox-disabled .ant-checkbox-inner:after{border-color:rgba(0,0,0,0.25);}.ant-checkbox-indeterminate .ant-checkbox-inner{background-color:', ';border-color:', ';}}&.ant-checkbox-wrapper{font-weight:normal;&:hover{.ant-checkbox-inner{border-color:', ';}}.checkBoxLabel{', ';}.ant-checkbox{display:inline-block;vertical-align:middle;}.ant-checkbox + span{min-width:125px;}.ant-checkbox-inner{width:14px;height:14px;border-radius:3px;border:1px solid ', ';&:after{left:3.5px;top:1.2px;}}.ant-checkbox-disabled{.ant-checkbox-inner{border:1px solid ', ';background-color:', ';}}.ant-checkbox-checked{&.ant-checkbox-disabled{.ant-checkbox-inner{border:1px solid ', ';background-color:', ';}}& > .ant-checkbox-inner{background-color:', ';border-color:', ';}}}'], _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, function (props) {
  return props.checked ? '' + _mixins2.default.blackLink() : '' + _mixins2.default.greyLink();
}, _theme2.default.colors.ALTO, _theme2.default.colors.ALTO, _theme2.default.colors.PEARL, _theme2.default.colors.ALTO, _theme2.default.colors.PEARL, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO);
