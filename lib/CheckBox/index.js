...
var MtCheckbox = (0, _styledComponents2.default)(_checkbox2.default).withConfig(
  ...
  [
    '&.ant-checkbox-wrapper{font-family:inherit;.ant-checkbox:hover .ant-checkbox-inner,.ant-checkbox-input:focus + .ant-checkbox-inner{border-color:',
    ...
    ';border-color:',
    ';}}&.ant-checkbox-wrapper{font-weight:normal;&:hover{.ant-checkbox-inner{border-color:',
    ';}}.checkBoxLabel{',
    ';}.ant-checkbox{display:inline-block;vertical-align:middle;}.ant-checkbox + span{min-width:125px;padding:0px;}.ant-checkbox-inner{width:14px;height:14px;border-radius:3px;border:1px solid ',
    ';&:after{left:3.5px;top:1.2px;}}.ant-checkbox-disabled{.ant-checkbox-inner{border:1px solid ',
    ';background-color:',
