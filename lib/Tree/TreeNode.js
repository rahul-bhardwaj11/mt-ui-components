  ...
  (0, _createClass3.default)(TreeNode, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          otherProps = (0, _objectWithoutProperties3.default)(_props, ['children', 'listIndex', 'swapFrom', 'swapLength', 'swapDepth', 'scaffoldBlockPxWidth', 'lowerSiblingCounts', 'connectDropTarget', 'isOver', 'draggedNode', 'canDrop', 'treeIndex', 'treeId', 'getPrevRow', 'node', 'path', 'rowDirection', 'className']);
      ...
      lowerSiblingCounts.forEach(function (lowerSiblingCount, i) {
        ...
        scaffold.push(_react2.default.createElement('div', {
          ...
          className: (0, _classnames2.default)('rst__lineBlock', lineClass, rowDirectionClass)
        }));
        ...
        if (treeIndex !== listIndex && i === swapDepth) {
          ...
          scaffold.push(_react2.default.createElement('div', {
            ...
            key: i,
            style: _style,
            className: (0, _classnames2.default)('rst__absoluteLineBlock', highlightLineClass, rowDirectionClass)
          }));
        }
      });
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        (0, _extends3.default)({}, otherProps, {
          className: (0, _classnames2.default)('rst__node', rowDirectionClass, className)
        }),
        scaffold,
