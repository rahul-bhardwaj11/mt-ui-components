...
})(['.ant-input-affix-wrapper{font-family:inherit;.ant-input:not(:last-child){padding:0px 30px 0px 30px;}}.ant-input-search:not(.ant-input-search-small){& > .ant-input-suffix{right:0px;left:12px;top:17px;width:14px;}}.ant-input-affix-wrapper:hover .ant-input:not(.ant-input-disabled){border:1px solid ', ';&:hover{border:1px solid ', ';}}.ant-input{color:', ';font-family:inherit;font-size:12px;border:1px solid ', ';&:hover{border:1px solid ', ';}&:focus{border:1px solid ', ';box-shadow:none;}}.ant-input-search > .ant-input-prefix > .ant-input-search-icon{display:none;}.icon-search{font-size:12px;color:', ';}.ant-input-affix-wrapper:focus .icon-search,.ant-input-affix-wrapper:active .icon-search,.ant-input-affix-wrapper:focus-within .icon-search{color:', ';}.ant-input-affix-wrapper .ant-input-suffix{top:17px;}.icon-close{font-size:10px;font-weight:600;color:', ';cursor:pointer;}'], _theme2.default.colors.ALTO, _theme2.default.colors.SILVER, _theme2.default.colors.SHARK, _theme2.default.colors.ALTO, _theme2.default.colors.SILVER, _theme2.default.colors.SILVER, _theme2.default.colors.ALTO, _theme2.default.colors.GREY, _theme2.default.colors.GREY);
...
var Search = function (_Component) {
  ...
  (0, _createClass3.default)(Search, [{
    ...
    value: function render() {
      ...
      var inputProps = (0, _extends3.default)({}, this.props, {
