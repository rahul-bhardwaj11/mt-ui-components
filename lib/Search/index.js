...
})(['.ant-input-affix-wrapper{.ant-input:not(:last-child){padding:0px 0px 0px 30px;}}.ant-input-search:not(.ant-input-search-small){& > .ant-input-suffix{right:0px;left:12px;top:17px;width:14px;}}.ant-input-affix-wrapper:hover .ant-input:not(.ant-input-disabled){border:1px solid ', ';&:hover{border:1px solid ', ';}}.ant-input{color:', ';font-family:\'Open Sans\',Arial,sans-serif;font-size:12px;border:1px solid ', ';&:hover{border:1px solid ', ';}&:focus{border:1px solid ', ';box-shadow:none;}}.ant-input-search > .ant-input-suffix > .ant-input-search-icon{font-weight:600;color:', ';cursor:default;}.ant-input-search:focus .ant-input-search-icon,.ant-input-search:focus-within .ant-input-search-icon,.ant-input-search:visited .ant-input-search-icon,.ant-input-search:active .ant-input-search-icon{color:', ';}'], _theme2.default.colors.ALTO, _theme2.default.colors.SILVER, _theme2.default.colors.SHARK, _theme2.default.colors.ALTO, _theme2.default.colors.SILVER, _theme2.default.colors.SILVER, _theme2.default.colors.ALTO, _theme2.default.colors.GREY);
