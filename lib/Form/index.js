...
})(['.ant-form-explain{margin-bottom:0px;margin-top:0px;line-height:20px;font-size:12px;}.ant-form-item{margin-bottom:0px;}.ant-form-item-control-wrapper{height:52px;}.ant-form-item-control{line-height:unset;}.has-error .ant-select-selection,.has-error .ant-form-explain,.has-error .ant-form-split{border-color:', ';color:', ';}.ant-input .ant-select-search__field{border-color:', ';}'], _theme2.default.colors.BITTERSWEET, _theme2.default.colors.BITTERSWEET, _theme2.default.colors.INDOGO);
