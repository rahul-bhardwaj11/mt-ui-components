...
})(['.ant-form-item-control{line-height:unset;.ant-form-explain{position:absolute;line-height:24px;font-size:12px;}}.ant-form-item{margin-bottom:0px;}.has-error .ant-select-selection,.has-error .ant-form-explain,.has-error .ant-form-split{border-color:', ';color:', ';}.ant-input .ant-select-search__field{border-color:', ';}'], _theme2.default.colors.BITTERSWEET, _theme2.default.colors.BITTERSWEET, _theme2.default.colors.INDOGO);
