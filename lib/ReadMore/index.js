...
var ALLOWED_HTML_TAGS = ['u', 'a', 'abbr', 'article', 'b', 'blockquote', 'br', 'caption', 'code', 'del', 'details', 'div', 'em', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'hr', 'i', 'img', 'ins', 'kbd', 'li', 'main', 'mark', 'ol', 'p', 'pre', 'section', 'span', 'strike', 'strong', 'sub', 'summary', 'sup', 'table', 'tbody', 'td', 'th', 'thead', 'tr', 'ul'];

var MTReadMore = _styledComponents2.default.div.withConfig({
  displayName: 'ReadMore__MTReadMore',
  componentId: 'sc-16y72y1-0'
})(['line-height:initial;ol{padding-left:16px;}ul{padding-left:18px;}.trunc-text{max-height:', ';overflow:hidden;}.viewMore,.viewLess{margin:10px 0px;display:block;', ';}.linkText{', ';}'], function (props) {
  return props.truncateHeight + 'px';
}, _mixins2.default.actionLink(), _mixins2.default.actionLink());
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !expanded && _react2.default.createElement(
          'div',
          { className: 'trunc-text', ref: function ref(e) {
              return _this2.ref = e;
            } },
          _react2.default.createElement('span', { dangerouslySetInnerHTML: { __html: truncateHTML.html } })
        ),
        expanded && _react2.default.createElement('span', { dangerouslySetInnerHTML: { __html: html } }),
        showViewMore && truncated && !expanded && _react2.default.createElement(
          'div',
        ...
        expanded && showViewMore && _react2.default.createElement(
          'span',
          { className: 'viewLess' },
          _react2.default.createElement(
            'a',
