...
var DateFilterStyle = _styledComponents2.default.div.withConfig({
  ...
  [
    '.ant-dropdown-trigger{position:relative;}.ant-dropdown-trigger + div{position:relative !important;}.dateInput{display:',
    ...
    ';}.dateCaret{color:',
    ';}}}.dateRangeDropdown{top:32px !important;left:0 !important;}.dateCaret{padding:4px 0;margin-left:10px;float:right;color:',
    ...
    ';}@media only screen and (max-width:767px){.ant-dropdown{position:relative;.ant-dropdown-menu{box-shadow:none;background-color:transparent;.ant-dropdown-menu-item{height:36px;padding:8px 0;margin:0;line-height:36px;background-color:transparent;',
    ';div{line-height:20px;}&:hover{color:',
    ';background-color:transparent;}}}}.dateRangeDropdown{position:fixed;top:0 !important;left:0 !important;width:100%;height:100%;padding:8px;background-color:rgba(0,0,0,0.2);.ant-calendar{display:table;height:100%;margin:0 auto;background-color:transparent;border:none;box-shadow:none;.ant-calendar-panel{display:table-cell;vertical-align:middle;.ant-calendar-date-panel{background:',
