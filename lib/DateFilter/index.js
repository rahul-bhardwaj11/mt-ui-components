  ...
  (0, _createClass3.default)(DateFilter, [
          ...
          this.setState({ date: date }, function() {
            _this2.state.date &&
              ...
              _this2.props.onChange(
                _this2.state.date.from,
                _this2.state.date.to,
                _this2.state.date.display
              );
          });
      }
    },
    {
      ...
      value: function render() {
        ...
        var isDateSelected =
          selectedDate &&
          selectedDate !== _dateFilterOptions.RANGE_PICKER_STATE;
        ...
        var dropDownProps = (0, _extends3.default)(
          {},
          mobile && { visible: openDropdown }
        );
        var RangePickerComponent = mobile
          ? _customRangePicker2.default
...
DateFilter.propTypes = {
  options: _propTypes2.default.arrayOf(
    _propTypes2.default.shape({
      ...
      resolver: _propTypes2.default.oneOfType([
