  ...
  (0, _createClass3.default)(DateFilter, [{
    ...
    value: function setDate(date) {
      ...
      this.setState({ date: date }, function () {
        _this2.state.date !== _dateFilterOptions.RANGE_PICKER_STATE && _this2.props.onChange(_this2.state.date);
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var _props = this.props,
          ...
          rangePickerProps = (0, _objectWithoutProperties3.default)(_props, ['options', 'placeholder', 'dateFormat']);
      var _state = this.state,
          setDate = _state.date,
          dropdownVisible = _state.dropdownVisible;

      var isDateSelected = setDate && setDate !== _dateFilterOptions.RANGE_PICKER_STATE;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Dropdown2.default,
          { onVisibleChange: this.dropdownVisibilityChange, placement: 'bottomLeft', options: options, trigger: 'click', onSelect: this.onSelect },
          _react2.default.createElement(
            'div',
        ...
        setDate === _dateFilterOptions.RANGE_PICKER_STATE && _react2.default.createElement(_datePicker.RangePicker, (0, _extends3.default)({}, rangePickerProps, {
          open: true,
