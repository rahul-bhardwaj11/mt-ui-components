...
var MtSwitch = _styledComponents2.default.div.withConfig({
  ...
  [
    ...
    ';}.ant-switch{min-width:36px;height:20px;color:',
    ';&:after{width:14px;height:14px;top:2px;margin-left:0px;}}.ant-switch-checked{&:after{width:14px;height:14px;top:2px;margin-left:-2px;}}'
  ],
...
var Switch = (function(_Component) {
  ...
  function Switch(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(
      this,
      (Switch.__proto__ || (0, _getPrototypeOf2.default)(Switch)).call(
        this,
        props
      )
    );
