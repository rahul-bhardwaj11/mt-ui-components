...
})(['.ant-switch-checked{background-color:', ';}.ant-switch{min-width:36px;height:20px;color:', ';&:after{width:14px;height:14px;top:2px;margin-left:0px;}}.ant-switch-checked{&:after{width:14px;height:14px;top:2px;margin-left:-2px;}}'], _theme2.default.colors.INDIGO, _theme2.default.colors.ALTO);
