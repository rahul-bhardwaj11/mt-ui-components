...
})(['font-family:inherit;.ant-radio-inner:after{background-color:white;}.ant-radio-checked{.ant-radio-inner{border-color:', ';background:', ';}}.ant-radio-wrapper{&:hover{span.ant-radio + *{color:', ';}.ant-radio{.ant-radio-inner{border:1px solid ', ';}}}}.ant-radio-wrapper-checked{span.ant-radio + *{color:', ';}}span.ant-radio + *{color:', ';}'], _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.SHARK, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.SHARK, _theme2.default.colors.SILVER);
