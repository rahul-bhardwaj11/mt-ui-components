...
var StyledToast = _styledComponents2.default.div.withConfig({
  ...
  [
    '.toast{border-radius:4px;text-align:center;padding:7px 24px 8px 24px;&.toast-info{background-color:#5dc778;}&.toast-success{background-color:#5dc778;}&.toast-warning{background-color:',
    ';}&.toast-error{background-color:',
    ';float:left;}&.toast-loading{background-color:',
    ';}.toastMessage{',
    ';}}.toastReloadBtn{',
    ';padding:6px 24px 7px 24px;border-radius:4px;cursor:pointer;border:1px solid ',
    ';background-color:',
    ';}'
  ],
