...
var ReloadBtn = function ReloadBtn() {
  return _react2.default.createElement(
    'div',
    {
      className: (0, _classnames3.default)('toastReloadBtn'),
...
var Toast = (function(_Component) {
  ...
  function Toast(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(
      this,
      (Toast.__proto__ || (0, _getPrototypeOf2.default)(Toast)).call(
        this,
        props
      )
    );
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.removeToast = function() {
    return setTimeout(_this2.props.onHide, _constants.TOAST_REMOVE_TIME);
  };
...
var show = function show(_ref2) {
  var message = _ref2.message,
    ...
    rest = (0, _objectWithoutProperties3.default)(_ref2, [
      'message',
      'type',
      'freeze',
      'mountId'
...
function hideToast() {
  ...
  _reactDom2.default.render(null, MountOn);
