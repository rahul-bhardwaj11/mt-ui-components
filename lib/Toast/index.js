...
var ReloadBtn = function ReloadBtn() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'span',
      { className: (0, _classnames3.default)('floatR', 'toastReloadBtn') },
      'Reload'
    )
  );
};
...
var Toast = function (_Component) {
  ...
  function Toast() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref2 = Toast.__proto__ || (0, _getPrototypeOf2.default)(Toast)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
      timer: null
    }, _this.style = {
      ...
      _this.stopTimer();
      _this.removeToast();
      _this.mountOn && _reactDom2.default.unmountComponentAtNode(_this.mountOn);
  ...
  (0, _createClass3.default)(Toast, [{
    ...
    value: function componentDidMount() {
      ...
      if (freeze) {
        ...
        _reactDom2.default.render(_react2.default.createElement(FreezeOverlay, null), this.mountOn);
      }
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          load && _react2.default.createElement(_Loader2.default, {
            size: 'sizeXSmall',
            style: { float: 'left' },
            vCenter: false
          }),
