...
var PdfPlayer = function (_Component) {
  ...
  function PdfPlayer() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = PdfPlayer.__proto__ || (0, _getPrototypeOf2.default)(PdfPlayer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      edit: false,
      ...
      return edit ? _react2.default.createElement(
        'div',
        null,
