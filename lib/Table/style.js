...
exports.default = _styledComponents2.default.div.withConfig({
  ...
  [
    ...
    ';}&.ant-table-column-has-filters .ant-table-column-sorter{visibility:hidden;}.ant-table-column-sorter > .ant-table-column-sorter-down{margin-top:0;}&.ant-table-column-has-filters.ant-table-column-sort .ant-table-column-sorter{visibility:visible;}}}}.ant-table-tbody{& > tr{color:',
    ';& > td{',
    ';background-color:white;border-bottom:1px solid ',
    ';padding:',
    ';&:last-child{padding:',
