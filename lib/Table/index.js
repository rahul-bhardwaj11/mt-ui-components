  ...
  function Table() {
    ...
    return (
      ...
      (_this.onChange = function(selectedRowKeys, selectedRows) {
        ...
        _this$props$rowSelect =
          _this$props$rowSelect === undefined ? {} : _this$props$rowSelect;
      ...
      (_this.getAntTableProps = function() {
        var _this$props5 = _this.props,
          ...
          rowKey =
            _this$props5$rowKey === undefined ? 'key' : _this$props5$rowKey,
              ...
              return {
                ...
                className: newSelectedRowskey.some(function(v) {
                  ...
                  : !(rowObject.isDisabled && rowObject.isDisabled())
                    ? ''
                    : (0, _classnames2.default)({ 'row-disabled': true })
              };
            }
          });
        } else {
