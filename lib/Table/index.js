...
var MtTable = _styledComponents2.default.div.withConfig({
  ...
  [
    ...
    ';}& .ant-checkbox > .ant-checkbox-inner{width:14px;height:14px;border-radius:3px;&:after{left:3px;top:1px;}}& > .ant-checkbox-checked{& > .ant-checkbox-inner{background-color:',
    ';border-color:',
    ';&:after{left:3px;top:1px;}}}& > .ant-checkbox-indeterminate{& > .ant-checkbox-inner{border-color:',
    ';&:after{left:6px;top:6px;background-color:',
    ';}}}.ant-checkbox:hover .ant-checkbox-inner,.ant-checkbox-input:focus + .ant-checkbox-inner{border-color:',
    ';}}'
  ],
  ...
  function(props) {
    ...
    _props$headerCellPadd =
      _props$headerCellPadd === undefined ? DEFAULT_TH_PADDING : _props$headerCellPadd;
  ...
  function(props) {
    ...
    _props$headerCellPadd2 =
      _props$headerCellPadd2 === undefined ? DEFAULT_TH_PADDING : _props$headerCellPadd2;
  ...
  function(props) {
    ...
    _props$contentCellPad =
      _props$contentCellPad === undefined ? DEFAULT_TD_PADDING : _props$contentCellPad;
  ...
  function(props) {
    ...
    _props$contentCellPad2 =
      _props$contentCellPad2 === undefined ? DEFAULT_TD_PADDING : _props$contentCellPad2;
  ...
  function(props) {
    ...
    _props$contentCellPad3 =
      _props$contentCellPad3 === undefined ? DEFAULT_TD_PADDING : _props$contentCellPad3;
  ...
  function(props) {
    ...
    _props$contentCellPad4 =
      _props$contentCellPad4 === undefined ? DEFAULT_TD_PADDING : _props$contentCellPad4;
  ...
  function Table() {
    ...
    return (
      (_ret = ((_temp = ((_this = (0, _possibleConstructorReturn3.default)(
        this,
        (_ref = Table.__proto__ || (0, _getPrototypeOf2.default)(Table)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      ...
      (_this.onScroll = function() {
        ...
        var height = windowScroll
          ...
          : Math.max(_this.scrollElement.scrollHeight, _this.scrollElement.clientHeight);
      ...
      (_this.getLoader = function() {
        ...
        var loaderProps = infiniteScroll
          ? (0, _extends3.default)({}, DEFAULT_LOADER_PROPS, {
              size: 'sizeXSmall',
              type: 'Small',
              style: {
                padding: '12px 0px'
  ...
  (0, _createClass3.default)(Table, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var antProps = updatedRowSelection
