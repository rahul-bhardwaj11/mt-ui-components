...
var Table = function (_Component) {
  ...
  function Table() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Table.__proto__ || (0, _getPrototypeOf2.default)(Table)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var loaderProps = loadingMore ? (0, _extends3.default)({}, _style.DEFAULT_LOADER_PROPS, {
        size: 'sizeXSmall',
        type: 'Small',
        style: {
          padding: '12px 0px',
      ...
      var _this$props4 = _this.props,
          ...
          rowKey = _this$props4$rowKey === undefined ? 'key' : _this$props4$rowKey,
      ...
      var antProps = updatedRowSelection && isMultiSelect ? (0, _extends3.default)({}, _this.props, {
      ...
      return {
        antTableProps: (0, _extends3.default)({}, antProps, { locale: locale }),
