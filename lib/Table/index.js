  ...
  (0, _createClass3.default)(Table, [{
    ...
    value: function componentWillReceiveProps() {
      ...
      if (selectAll && dataSource.length > selectedRowKeys.length) {
        this.onChange(dataSource.map(function (v) {
          return v.key;
        }), dataSource);
      }
    }
