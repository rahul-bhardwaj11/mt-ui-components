    ...
    return (
      ...
      (_this.getAntTableProps = function() {
        var _this$props6 = _this.props,
          ...
          rowKey =
            _this$props6$rowKey === undefined ? 'key' : _this$props6$rowKey,
    ...
    },
    {
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.loading !== this.props.loading) {
          d.loadingMore = !nextProps.loading ? false : this.state.loadingMore;
        }
        if (nextProps.selectedRowKeys) {
          d.showActionBar = !!nextProps.selectedRowKeys.length;
        }
        this.setState(d);
      }
    },
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _state2 = this.state,
          ...
          loadingMore = _state2.loadingMore;
