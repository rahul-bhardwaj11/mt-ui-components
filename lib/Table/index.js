...
var Table = function (_Component) {
  ...
  (0, _createClass3.default)(Table, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var _nextProps$rowSelecti = nextProps.rowSelection;
      _nextProps$rowSelecti = _nextProps$rowSelecti === undefined ? {} : _nextProps$rowSelecti;
      var selectedRowKeys = _nextProps$rowSelecti.selectedRowKeys;
