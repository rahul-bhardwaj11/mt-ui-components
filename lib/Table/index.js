...
var MtTable = _styledComponents2.default.div.withConfig({
  ...
  [
    ...
    ';padding:',
    ';&:last-child{padding:',
    ';}.ant-table-column-sorter > .ant-table-column-sorter-down{margin-top:0;}}}}.ant-table-tbody{& > tr{color:',
    ';& > td{',
    ';background-color:white;border-bottom:1px solid ',
    ';padding:',
    ';&:last-child{padding:',
    ...
    ';}& .ant-checkbox > .ant-checkbox-inner{width:14px;height:14px;border-radius:3px;transition:none;&:after{left:3.5px;top:1.2px;}}& > .ant-checkbox-checked{& > .ant-checkbox-inner{background-color:',
    ';border-color:',
    ...
    ';border-color:',
    ';}}.ant-table-column-sorter .anticon-caret-up,.ant-table-column-sorter .anticon-caret-down{color:',
