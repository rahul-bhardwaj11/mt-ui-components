...
var MtTable = _styledComponents2.default.div.withConfig({
  displayName: 'Table__MtTable',
  componentId: 'am90om-0'
})(['counter-reset:rowNumber;.ant-table-default > .ant-table-content > .ant-table-body > table,.ant-table-middle > .ant-table-content > .ant-table-body > table,.ant-table-small > .ant-table-content > .ant-table-body > table,.ant-table-default > .ant-table-content > .ant-table-scroll > .ant-table-header > .ant-table-fixed,.ant-table-default > .ant-table-content > .ant-table-scroll > .ant-table-body > .ant-table-fixed,.ant-table-default > .ant-table-content > .ant-table-scroll > .ant-table-body,.ant-table-default > .ant-table-content > .ant-table-scroll > .ant-table-header,.ant-table-default > .ant-table-content > .ant-table-fixed-left > .ant-table-header > .ant-table-fixed,.ant-table-default > .ant-table-content > .ant-table-fixed-left > .ant-table-body-outer > .ant-table-body-inner > .ant-table-fixed,.ant-table-default > .ant-table-content > .ant-table-fixed-right > .ant-table-header > .ant-table-fixed,.ant-table-default > .ant-table-content > .ant-table-fixed-right > .ant-table-body-outer > .ant-table-body-inner > .ant-table-fixed{.ant-table-thead{& > tr{color:', ';& > th{', ';background-color:white;border-bottom:1px solid ', ';padding:', ';&:last-child{padding:', ';}.ant-table-column-sorter > .ant-table-column-sorter-down{margin-top:0;}}}}.ant-table-tbody{& > tr{color:', ';& > td{', ';background-color:white;border-bottom:1px solid ', ';padding:', ';&:last-child{padding:', ';}}}}.ant-table-row{counter-increment:rowNumber;&:hover{.ant-table-selection-column{', ';}}}.ant-table-tbody{counter-reset:rowNumber;.ant-table-selection-column{', ';}& > tr{color:', ';&:focus-within{& > td{background:', ';}}td{', ';border-bottom:1px solid ', ';padding:', ';&:last-child{padding:', ';}}&.ant-table-row-selected{& > td{background:', ';}&:hover{& > td{background:', ';}}}&.ant-table-row-hover{& > td{background:', ';}&:hover{& > td{background:', ';}}}&:hover{& > td{background:', ';}}}}}.ant-table-thead > tr > th.ant-table-selection-column,.ant-table-tbody > tr > td.ant-table-selection-column{min-width:auto;}.ant-checkbox-wrapper{&:hover .ant-checkbox-inner{border-color:', ';}& .ant-checkbox > .ant-checkbox-inner{width:14px;height:14px;border-radius:3px;transition:none;&:after{left:3.5px;top:1.2px;}}& > .ant-checkbox-checked{& > .ant-checkbox-inner{background-color:', ';border-color:', ';&:after{left:3.5px;top:1.2px;}}}.ant-checkbox:hover .ant-checkbox-inner,.ant-checkbox-input:focus + .ant-checkbox-inner{border-color:', ';}.ant-checkbox-indeterminate .ant-checkbox-inner:after{content:\' \';position:absolute;left:50%;top:50%;width:9.14285714px;height:2px;transform:translate(-50%,-50%) scale(1);background-color:#ffffff;}.ant-checkbox-indeterminate.ant-checkbox-disabled .ant-checkbox-inner:after{border-color:rgba(0,0,0,0.25);}.ant-checkbox-indeterminate .ant-checkbox-inner{background-color:', ';border-color:', ';}}.ant-table-column-sorter .anticon-caret-up,.ant-table-column-sorter .anticon-caret-down{color:', ';}.ant-table-column-sorter-up.on .anticon-caret-up,.ant-table-column-sorter-down.on .anticon-caret-up,.ant-table-column-sorter-up.on .anticon-caret-down,.ant-table-column-sorter-down.on .anticon-caret-down{color:', ';}'], _theme2.default.colors.DARK_OUTER_SPACE, _mixins2.default.smallDarkLink(), _theme2.default.colors.ALTO, function (props) {
...
var Table = function (_Component) {
  ...
  function Table() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Table.__proto__ || (0, _getPrototypeOf2.default)(Table)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    }, _this.tableRef = null, _this.fetch = function () {
      ...
      var loaderProps = infiniteScroll ? (0, _extends3.default)({}, DEFAULT_LOADER_PROPS, {
        size: 'sizeXSmall',
        type: 'Small',
        style: {
          padding: '12px 0px',
  ...
  (0, _createClass3.default)(Table, [{
    ...
    value: function componentDidMount() {
      ...
      if (infiniteScroll && this.tableRef) {
        this.scrollElement = windowScroll ? window : this.tableRef.getElementsByClassName('ant-table-body')[0];
    ...
    value: function componentWillReceiveProps(nextProp) {
      var dataSource = nextProp.dataSource;
      var _state = this.state,
          selectAll = _state.selectAll,
          selectedRowKeys = _state.selectedRowKeys;

      var selectedRows = dataSource.filter(function (v) {
      ...
      if (selectedRowKeys.length !== selectedRows.length) this.onChange(selectedRows.map(function (row) {
        return row.key;
      }), selectedRows);
    }
  }, {
    ...
    value: function render() {
      ...
      var _state2 = this.state,
          ...
          showMultiSelect = _state2.showMultiSelect,
      ...
      var updatedRowSelection = rowSelection ? (0, _extends3.default)({}, rowSelection, {
