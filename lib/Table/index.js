...
var Table = function (_Component) {
  ...
  function Table() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Table.__proto__ || (0, _getPrototypeOf2.default)(Table)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this$props3$rowSelec = _this$props3$rowSelec === undefined ? {} : _this$props3$rowSelec;
      ...
      var _this$props4 = _this.props,
          _this$props4$emptyTab = _this$props4.emptyTableMsg,
          title = _this$props4$emptyTab.title,
          subtitle = _this$props4$emptyTab.subtitle,
      ...
      var _this$props6 = _this.props,
          ...
          parentKeys = _this$props6.selectedRowKeys,
          isMultiSelect = _this$props6.isMultiSelect,
          _this$props6$rowKey = _this$props6.rowKey,
          rowKey = _this$props6$rowKey === undefined ? 'key' : _this$props6$rowKey,
          _onRow = _this$props6.onRow,
          locale = _this$props6.locale;
      var _this$state = _this.state,
          selectAll = _this$state.selectAll,
          selectedRowKeys = _this$state.selectedRowKeys;

      var newSelectedRowskey = selectAll ? dataSource.map(function (v) {
        return v[rowKey];
        ...
        antProps = (0, _extends3.default)({}, _this.props, {
          ...
          onRow: function onRow(record) {
            ...
            return {
              ...
              }) ? (0, _classnames2.default)('ant-table-row-selected', _this.props.selectRowClassName, { 'row-disabled': true }) : !(rowObject.isDisabled && rowObject.isDisabled()) ? '' : (0, _classnames2.default)({ 'row-disabled': true })
            };
          }
        });
      } else {
