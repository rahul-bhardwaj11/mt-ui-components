...
var ANTD_BUTTON_SIZE_PADDING = {
  large: '0px 32px',
  medium: '0px 24px',
  small: '0px 12px'
};

var MtButton = _styledComponents2.default.div(_templateObject, _theme2.default.colors.ALTO, function (props) {
  ...
  (0, _createClass3.default)(Button, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        MtButton,
        { active: active, disabled: disabled, size: size || 'large' },
