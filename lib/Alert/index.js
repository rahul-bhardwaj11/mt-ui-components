...
var AlertBox = function (_Component) {
  ...
  function AlertBox() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = AlertBox.__proto__ || (0, _getPrototypeOf2.default)(AlertBox)).call.apply(_ref, [this].concat(args))), _this), _this.close = function (action) {
...
var Alert = function (_Component2) {
  ...
  function Alert() {
    ...
    return _ret2 = (_temp2 = (_this3 = (0, _possibleConstructorReturn3.default)(this, (_ref2 = Alert.__proto__ || (0, _getPrototypeOf2.default)(Alert)).call.apply(_ref2, [this].concat(args))), _this3), _this3.state = {
      alerts: []
      ...
      return _this3.state.alerts.map(function (alert) {
        return _react2.default.createElement(
          AlertBox,
          (0, _extends3.default)({}, alert, { key: alert.id, removeAlert: _this3.removeAlert }),
          alert.message
        );
      });
