...
})(['.ant-slider-handle{border:2px solid ', ';background-color:', ';', ';&:focus{box-shadow:0 0 0 0 ', ';border-color:2px solid ', ';}&.ant-tooltip-open{&:hover{border:2px solid ', ';}}&:hover{.ant-slider-handle:not(.ant-tooltip-open){background-color:', ';border:2px solid ', ';}}}.ant-slider-dot{background:transparent;border-color:transparent;}.ant-slider-rail{background:', ';height:3px;}.ant-slider-track{background-color:', ';}.ant-slider{&:hover{.ant-slider-handle:not(.ant-tooltip-open){background-color:', ';border:2px solid ', ';}}}.ant-slider{&:hover{.ant-slider-track{background-color:', ';border:2px solid ', ';}}}.ant-slider-disabled{cursor:default;.ant-slider-track{border:2px solid  ', ' !important;}&.ant-slider:hover .ant-slider-track{border:2px solid  ', ';}&:hover{.ant-slider-track{background-color:', '  &:hover{background-color:', '}}}.ant-slider-disabled.ant-slider:hover .ant-slider-track{border:2px solid  ', ';}.ant-slider-mark-text,.ant-slider-disabled .ant-slider-dot{cursor:default !important;}.ant-slider-dot{display:none;cursor:default !important;}.ant-slider-handle{background-color:', ' !important;border-color:', ' !important;cursor:default;}}'], _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _mixins2.default.size('12px', '12px'), _theme2.default.colors.BITTERSWEET, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.ALTO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.SILVER, _theme2.default.colors.SILVER, _theme2.default.colors.SILVER, _theme2.default.colors.SILVER, _theme2.default.colors.SILVER, _theme2.default.colors.SILVER, _theme2.default.colors.SILVER);
