...
var Elevation = (0, _styledComponents2.default)('div').withConfig({
  displayName: 'Elevation',
  componentId: 'sc-204401-0'
})(['border:', ';border-radius:', ';background-color:#ffffff;box-sizing:border-box;box-shadow:', ';padding:', ';width:', ';'], _theme2.default.colors.PEARL, function (_ref) {
