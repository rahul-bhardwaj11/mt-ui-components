...
})(['border:1px solid ', ';border-radius:', ';background-color:#ffffff;box-sizing:border-box;box-shadow:', ';padding:', ';width:', ';min-height:', ';{...props.style;}'], _theme2.default.colors.PEARL, function (_ref) {
