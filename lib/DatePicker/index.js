...
})(['font-family:inherit;.ant-calendar-picker-container{font-family:inherit;z-index:9999;}.ant-calendar-selected-day{.ant-calendar-date{background:', ';border:1px solid ', ';border-radius:4px;color:#fff;}}.ant-calendar-last-month-cell{.ant-calendar-date{color:', ';}}.ant-calendar-date{color:', ';font-size:12px;font-weight:600;&:hover{background:', ';border:1px solid ', ';border-radius:4px;color:#fff;}}.ant-calendar-column-header-inner{color:', ';font-size:12px;font-weight:600;text-transform:uppercase;}.ant-calendar-next-month-btn-day .ant-calendar-date{color:', ';}'], _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.DARK_OUTER_SPACE, _theme2.default.colors.INDIGO, _theme2.default.colors.INDIGO, _theme2.default.colors.OUTER_SPACE, _theme2.default.colors.OUTER_SPACE);
