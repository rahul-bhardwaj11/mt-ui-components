...
var StyledDatePicker = _styledComponents2.default.div.withConfig({
  ...
  [
    'font-family:inherit;.ant-calendar-picker-container{font-family:inherit;z-index:9999;}.ant-calendar-selected-day{.ant-calendar-date{background:',
    ';border:1px solid ',
    ';border-radius:4px;color:#fff;}}.ant-calendar-last-month-cell{.ant-calendar-date{color:',
    ';}}.ant-calendar-date{color:',
    ';font-size:12px;font-weight:600;&:hover{background:',
    ';border:1px solid ',
    ';border-radius:4px;color:#fff;}}.ant-calendar-column-header-inner{color:',
    ';font-size:12px;font-weight:600;text-transform:uppercase;}.ant-calendar-next-month-btn-day .ant-calendar-date{color:',
    ';}'
  ],
...
var StyleSelectCalendar = _styledComponents2.default.span.withConfig({
  ...
  [
    'position:relative;.ant-input{&:hover{border:1px solid ',
    ';}&:focus{box-shadow:0 0 0 0 transparent;}}.ant-calendar-picker-input{z-index:1;background:transparent;padding-right:20px;}.ant-calendar-picker-icon,.ant-calendar-picker-clear{display:none;&:hover{display:none;}}.customCalendarIcon{position:absolute;right:7px;top:2px;color:',
    ';}'
  ],
  _theme2.default.colors.INDIGO,
  _theme2.default.colors.OUTER_SPACE
