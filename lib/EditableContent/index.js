...
})(['padding:6px 12px;.editableText{float:left;margin-right:12px;}.icon-edit{cursor:pointer;}']);
...
var EditableContent = function (_Component) {
  ...
  function EditableContent() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = EditableContent.__proto__ || (0, _getPrototypeOf2.default)(EditableContent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
