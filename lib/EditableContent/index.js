...
})(['padding:6px 12px;.editableText{float:left;cursor:pointer;padding-right:26px;}.icon-edit{cursor:pointer;}.editableWrapper{float:left;position:relative;max-width:100%;}']);
  ...
  (0, _createClass3.default)(EditableContent, [{
    ...
    value: function renderEditingComponent() {
      var _props = this.props,
          ...
          inputProps = (0, _objectWithoutProperties3.default)(_props, ['editOnEnter']);
