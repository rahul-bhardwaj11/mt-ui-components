...
var StyledEditableInput = _styledComponents2.default.div(_templateObject2);
    ...
    return (
      ...
      (_this.handleSave = function() {
        if (_this.state.nextValue) {
          ...
          _this.props.onSave(_this.state.nextValue);
    ...
    },
    {
      ...
      value: function renderStaticComponent() {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'clearfix', onClick: this.toggleEditMode },
            _react2.default.createElement(
              'div',
