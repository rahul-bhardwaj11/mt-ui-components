...
})(['padding:6px 12px;.editableText{float:left;cursor:pointer;padding-right:26px;}.icon-edit{cursor:pointer;position:absolute;top:3px;right:0px;}.editableWrapper{float:left;position:relative;max-width:100%;}']);
...
})(['.editableInputControl{width:40%;float:left;position:relative;.icon-close{font-size:10px;}}.editableContentSaveBtn,.editableContentCancelBtn{margin:4px 0px 0px 12px;padding:0px 12px;}.ant-input-group-addon{width:32px;font-size:11px;padding:0 6px;background-color:', ';}'], _theme2.default.colors.WHITE);
...
var EditableContent = function (_Component) {
  ...
  function EditableContent() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = EditableContent.__proto__ || (0, _getPrototypeOf2.default)(EditableContent)).call.apply(_ref, [this].concat(args))), _this), _this.getInitialState = function () {
      return {
        editing: false,
        nextValue: _this.props.value
      };
    }, _this.state = _this.getInitialState(), _this.toggleEditMode = function (editing) {
  ...
  (0, _createClass3.default)(EditableContent, [{
    ...
    value: function renderEditingComponent() {
      var _props = this.props,
          ...
          inputProps = (0, _objectWithoutProperties3.default)(_props, ['editOnEnter', 'showRemainingCharacterCount']);

      if (editOnEnter) {
        inputProps.onPressEnter = this.handleSave;
        inputProps.onBlur = this.handleSave;
        inputProps.suffix = _react2.default.createElement(_Icon2.default, { type: 'close', onClick: this.handleClear });
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Input2.default, (0, _extends3.default)({}, inputProps, {
            ...
            addonAfter: showRemainingCharacterCount && inputProps.maxLength && String(inputProps.maxLength - this.state.nextValue.length)
          }))
        ),
        !editOnEnter && _react2.default.createElement(
    ...
    value: function renderStaticComponent() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'clearfix editableWrapper', onClick: this.toggleEditMode },
          _react2.default.createElement(
            'div',
