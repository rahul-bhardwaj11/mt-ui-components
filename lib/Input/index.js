...
var MtInput = _styledComponents2.default.div.withConfig({
  ...
  [
    '.counterStyle{color:#696969;font-size:12px;margin-left:0;padding:4px 8px;border:1px solid #ccc;border-left:none;line-height:20px;float:left;}.displayN{display:none;}.error{font-size:12px;bottom:-20px;left:2px;position:absolute;color:',
    ';}.ant-input.errorInputStyle{border:1px solid red;&:focus,&:hover{border:1px solid #f5222d;}}.ant-input{border:1px solid ',
    ';font-family:inherit;}.ant-input{&:hover{border-color:',
    ';}}.ant-input{&.active,&:focus{border-color:',
    ';outline:0;box-shadow:0 4px 8px 0 rgba(0,0,0,0.08);}}.ant-input-disabled{border-color:',
