...
var MtInput = _styledComponents2.default.div.withConfig({
  ...
  [
    '.counterStyle{color:#696969;font-size:12px;margin-left:0;padding:4px 8px;border:1px solid #ccc;border-left:none;line-height:20px;float:left;}.displayN{display:none;}.error{font-size:12px;bottom:-24px;left:8px;position:absolute;color:#c63434;font-weight:bold;}.ant-input{border:1px solid ',
    ';}.ant-input{&:hover{border-color:',
    ';}}.ant-input{&:focus{border-color:',
    ';outline:0;box-shadow:0 0 0 0px rgba(24,144,255,0.2);}}.ant-input-disabled{border-color:',
    ';background-color:#f8f8f8;color:',
    ';&:hover{border-color:',
    ';}}.ant-input-error{border-color:#ff6060;}'
  ],
...
var Input = (function(_Component) {
  ...
  function Input(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(
      this,
      (Input.__proto__ || (0, _getPrototypeOf2.default)(Input)).call(this, props)
    );
          ...
          _react2.default.createElement(
            'div',
            {
              ...
              className: (0, _classnames3.default)(
                ((_classnames = {}),
                (0, _defineProperty3.default)(_classnames, 'counterStyle', maxLength),
                (0, _defineProperty3.default)(_classnames, 'displayN', !maxLength),
                _classnames),
                maxLengthClassName
              )
            },
