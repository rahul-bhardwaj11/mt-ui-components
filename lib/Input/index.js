...
})(['position:relative;.counterStyle{', ';line-height:20px;position:absolute;right:0px;}.displayN{display:none;}.error{font-size:12px;bottom:-20px;left:2px;position:absolute;color:', ';}.ant-input.errorInputStyle{border:1px solid red;&:focus,&:hover{border:1px solid #f5222d;}}.ant-input{border:1px solid ', ';font-family:inherit;}.ant-input{&:hover{border-color:', ';}}.ant-input{&.active,&:focus{border-color:', ';outline:0;box-shadow:0 4px 8px 0 rgba(0,0,0,0.08);}}.ant-input-disabled{border-color:', ';background-color:#f8f8f8;color:', ';&:hover{border-color:', ';}}.ant-input-error{border-color:#ff6060;}'], _mixins2.default.smallGreyLink(), _theme2.default.colors.BITTERSWEET, _theme2.default.colors.ALTO, _theme2.default.colors.SILVER, _theme2.default.colors.SILVER, _theme2.default.colors.DISABLE, _theme2.default.colors.SILVER, _theme2.default.colors.DISABLE);
  ...
  (0, _createClass3.default)(Input, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          rest = (0, _objectWithoutProperties3.default)(_props2, ['errors', 'maxLength', 'maxLengthClassName', 'showMaxLength', 'wrapperClassName', 'className']);
      var value = this.state.value;

      return _react2.default.createElement(
        MtInput,
        { className: wrapperClassName },
        _react2.default.createElement(_input2.default, (0, _extends3.default)({}, rest, {
          value: value,
          onChange: this.onChange,
          onFocus: this.moveCaretAtEnd,
          className: (0, _classnames3.default)(className, { errorInputStyle: errors[0] })
        })),
        maxLength && showMaxLength && _react2.default.createElement(
          'div',
          {
            key: 'maxLength',
