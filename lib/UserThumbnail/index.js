...
})(['.userThumbnailAvatar{float:left;}.userThumbnailInfo{height:40px;margin-left:16px;padding-top:2px;float:left;.name{', ';', ';}.content{', ';', ';}}'], _mixins2.default.blackText(), _mixins2.default.truncate(), _mixins2.default.smallDarkLink(), _mixins2.default.truncate());
