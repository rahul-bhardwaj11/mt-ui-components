...
})(['.userThumbnailAvatar{float:left;}.userThumbnailInfo{height:40px;margin-left:56px;cursor:default;.name{', ';', ';.alertMsg{', ';margin-left:6px;}}.content{', ';font-size:12px;', ';}}'], _mixins2.default.blackLink(), _mixins2.default.truncate(), _mixins2.default.smallDarkLink(), _mixins2.default.darkText(), _mixins2.default.truncate());
