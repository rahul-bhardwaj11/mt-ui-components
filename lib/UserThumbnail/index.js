...
})(['.userThumbnailAvatar{float:left;}.userThumbnailInfo{height:40px;margin-left:56px;cursor:default;.title{', ';', ';.alertMsg{', ';}}.content{', ';', ';}}'], _mixins2.default.blackLink(), _mixins2.default.truncate(), _mixins2.default.smallDarkLink(), _mixins2.default.darkText(), _mixins2.default.truncate());
  ...
  (0, _createClass3.default)(UserThumbnail, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          rest = (0, _objectWithoutProperties3.default)(_props2, ['expanded', 'className', 'icon', 'children']);
      var title = rest.title;


      var mtProps = (0, _assign2.default)({}, rest);
      mtProps = !title && !children ? (0, _assign2.default)(mtProps, { icon: icon || 'user' }) : mtProps;
      return _react2.default.createElement(
        MtUserThumbnail,
        { className: className },
        _react2.default.createElement(
        ...
        expanded && _react2.default.createElement(UserThumbnailInfo, (0, _extends3.default)({}, rest, { className: 'userThumbnailInfo' }))
      );
    }
  }]);
