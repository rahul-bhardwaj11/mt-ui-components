...
var MtUserThumbnail = (0, _styledComponents2.default)('div').withConfig({
  displayName: 'UserThumbnail__MtUserThumbnail',
  componentId: 'l59wso-0'
})(['display:inline-block;.content{display:inline-block;vertical-align:middle;margin-left:16px;.name{', ';line-height:22px;}.email{', ';line-height:17px;}}'], _mixins2.default.blackText(), _mixins2.default.smallDarkLink());
